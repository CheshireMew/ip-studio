...
Use the attached canonical base, completed standard contact sheet, layout guide, and approved four-cardinal strip for identity, scale, registration, spacing, direction semantics, and cross-row continuity. The layout guide's red arrows point toward the required SCREEN edge for each slot; treat them as semantic targets and never draw the arrows or guide marks. Read `qa/look-mechanics.md` and follow its pet-specific movement and eye/prop mechanics. {reference_instruction}
...
Use the canonical base, standard contact sheet, layout guide, approved four-cardinal strip, and `qa/look-mechanics.md`. The layout guide's red arrows point toward the required SCREEN edge for each slot; use them as semantic targets and never draw the arrows or guide marks. Draw the complete eight-pose row as one coherent animation family, interpolating even 22.5-degree steps between the cardinal pose families. Keep the same pet identity, face construction, materials, palette, markings, and props. Each direction must read correctly at pet size and join continuously at the 000 and 180 boundaries.
...
Use the attached canonical base, completed standard contact sheet, and layout guide for exact identity, style, scale, baseline, face construction, materials, palette, markings, props, and spacing. The layout guide's red arrows point toward the required SCREEN edge for each slot; treat them as semantic targets and never draw the arrows or guide marks. Read `qa/look-mechanics.md` and use the pet's natural gaze mechanism.
